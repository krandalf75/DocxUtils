...
/**
 * Takes existing images internal to the package, and points at them with
 * TargetMode="External", and r:link (instead of r:embed).
 *
...
public class ImageConvertEmbeddedToLinked {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            Args.parse(ImageConvertEmbeddedToLinked.class, args);
        } catch (IllegalArgumentException e) {
            Args.usage(ImageConvertEmbeddedToLinked.class);
            System.exit(-1);
        }
        ...
        for (Relationship r : relsList) {
            ...
            if (r.getType().equals(Namespaces.IMAGE)
                ...
                if (saveImages) {
                    ...
                    File f = new File(outputDir, target);
                    if (f.exists()) {
